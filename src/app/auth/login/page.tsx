...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/erp/api/method/login", {
        method: "POST",
      ...
      if (res.ok) {
        // Login successful – cookie is set for the domain
        ...
        <div className="hidden lg:flex flex-col justify-between bg-background/50 backdrop-blur-xl border border-white/20 p-10 rounded-[2rem] shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <Link href="/" className="flex items-center gap-2 mb-12">
              ...
              <span className="font-black text-xl tracking-tighter text-secondary">
                Crown<span className="opacity-70">Canteen</span>
              </span>
            </Link>
        ...
        <div className="flex flex-col justify-center">
          <div className="bg-background/60 backdrop-blur-xl border border-white/20 p-8 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-8 text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-secondary tracking-tighter mb-2">
                Welcome Back
              </h2>
              <p className="text-muted-foreground text-sm font-medium">
                Please sign in to your institutional account.
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link href="#" className="text-[9px] font-black text-primary uppercase tracking-widest hover:underline">
                    Forgot?
                  </Link>
                </div>
                <div className="relative group">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-12 mt-4 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-black text-sm shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-3 group hover:-translate-y-0.5 disabled:opacity-70"
              >
                {loading ? (
                  <>
